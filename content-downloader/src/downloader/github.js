...
async function downloadProjectImage (projectName, githubUser, targetProjectDir) {
...
async function downloadReleases (projectName, githubUser, gotHeaders) {
...
async function removeBadgesAndDownloadImages (markdownContent, githubUser, projectName, mainBranch, targetProjectDir) {
