...
export const gistIds = [
  // '7e28d4eb4bf500f7ee8012c4a0cf7bbf', // AesGcmTest.java
...
export const githubProjects = [
  ...
  { repo: 'Dali' },
  { repo: 'under-the-hood' },
  { repo: 'density-converter' },
  { repo: 'uber-apk-signer' },
  { repo: 'armadillo' },
  { repo: 'BlurTestAndroid' },
  { repo: 'uber-adb-tools' },
  { repo: 'bytes-java' },
  { repo: 'indoor-positioning' },
  { repo: 'hkdf' },
  { repo: 'slf4j-timber' },
  { repo: 'id-mask' },
  { repo: 'dice' },
  { repo: 'singlestep-kdf' },
  { repo: 'bkdf' },
  { repo: 'rocketchat-exporter' },
  { repo: 'docker-minipaint' },
  { repo: 'planb-android' },
  { repo: 'checkstyle-config' },
